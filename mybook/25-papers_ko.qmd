...
- 2024:
[김정우, 최지원](inputs/pdfs/kim_choi.pdf);
[탈리아 파브레가스, 파티마 유누사, 아미시 순딥 아바르세카르](inputs/pdfs/fabregas_yunusa_avarsekar.pdf).
- 2020: [알렌 미트로프스키, 샤오얀 양, 매튜 완키에비치](inputs/pdfs/paper_five_2020-Mitrovski_Yang_Wankiewicz.pdf) (이 논문은 ASA 2020년 12월 학부 통계 연구 프로젝트 대회에서 "우수상"을 받았습니다.)
