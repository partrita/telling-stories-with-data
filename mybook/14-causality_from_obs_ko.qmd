...
심슨의 역설은 종종 캘리포니아 대학교 버클리\index{Berkeley}의 대학원 입학에 대한 실제 데이터를 사용하여 설명됩니다[@bickel1975sex]. 이 논문은 [@sec-on-writing]에서 출판된 가장 훌륭한 부제목 중 하나로 언급되었습니다. @Hernn2011은 관계와 역설의 원인을 더 자세히 설명하는 DAG를 생성합니다.
